...
public class FlywheelConfig {
  ...
  public static final double FLYWHEEL_RIGHT_TARGET_ACCELERATION = 400;
  public static final double FLYWHEEL_RIGHT_P = .1;
  public static final double FLYWHEEL_RIGHT_I = 0;
  public static final double FLYWHEEL_RIGHT_D = 0;
  public static final double FLYWHEEL_RIGHT_S = 0.19;
  public static final double FLYWHEEL_RIGHT_V = .12;
  public static final double FLYWHEEL_RIGHT_A = 0;

  // Set
  public static final double FLYWHEEL_LEFT_MAX_CRUISE_VELOCITY = 3000;
  public static final double FLYWHEEL_LEFT_TARGET_ACCELERATION = 400;
  public static final double FLYWHEEL_LEFT_P = .1;
  public static final double FLYWHEEL_LEFT_I = 0;
  public static final double FLYWHEEL_LEFT_D = 0;
  public static final double FLYWHEEL_LEFT_S = 0.19;
  public static final double FLYWHEEL_LEFT_V = .12;
  ...
  public static final double FLYWHEEL_TRENCH_SHOT_SPEED = 40;
  public static final double FLYWHEEL_PASS_SPEED = 60;
  ...
  public static final double FLYWHEEL_DEPOT_SHOT_SPEED = 37;
}
